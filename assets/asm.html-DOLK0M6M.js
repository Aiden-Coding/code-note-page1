import{_ as i,r as l,o as t,c,a as n,b as s,d,e as a}from"./app-GjP6hEVt.js";const o="/code-note-page1/assets/image-60-Ki3osnet.png",p="/code-note-page1/assets/image-61-dRAacp9z.png",u="/code-note-page1/assets/image-54-zR6P22W4.png",r="/code-note-page1/assets/image-55-UFiazv6y.png",v="/code-note-page1/assets/image-62-pOY51F7D.png",m={},b=a('<h1 id="史上最通俗易懂的asm教程" tabindex="-1"><a class="header-anchor" href="#史上最通俗易懂的asm教程" aria-hidden="true">#</a> 史上最通俗易懂的ASM教程</h1><h2 id="一勺思想" tabindex="-1"><a class="header-anchor" href="#一勺思想" aria-hidden="true">#</a> 一勺思想</h2><p>We are all in the gutter, but some of us are looking at the stars. （我们都生活在阴沟里，但仍有人仰望星空 ）- 王尔德 《温德米尔夫人的扇子》</p><p>举世混浊我独清，众人皆醉我独醒 - 屈原 《楚辞》</p><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>ASM是一种通用Java字节码操作和分析框架。它可以用于修改现有的class文件或动态生成class文件。</p>',6),k={href:"https://asm.ow2.io/performance.html",target:"_blank",rel:"noopener noreferrer"},g=a('<p>本篇文章分享的是对ASM的理解和应用，之前需要我们掌握<strong>class字节码</strong>，<strong>JVM基于栈的设计模式,JVM指令</strong></p><h2 id="class字节码" tabindex="-1"><a class="header-anchor" href="#class字节码" aria-hidden="true">#</a> class字节码</h2><p>我们编写的java文件，会通过javac命令编译为class文件，JVM最终会执行该类型文件来运行程序。下图所示为class文件结构。</p><p><img src="'+o+`" alt="Alt text"></p><p>下面我们通过一个简单的实例来进行说明。下面是我们编写的一个简单的java文件，只是简单的函数调用.</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
